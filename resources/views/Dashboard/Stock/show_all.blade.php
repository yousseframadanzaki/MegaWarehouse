            ...
            <form method="GET" action="{{route('all_stocks')}}" id="search">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <select class="form-select product_info" aria-label="Default  select example" name="warehouse_id" style="padding: 0.375rem 0.75rem;">
                            <option value="">اختار المخزن</option>
                            @foreach ($data['warehouses'] as $id => $name)
                                <option @if(Request::get('warehouse_id') == $id) selected @endif value="{{ $id }}">{{ $name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select product_info" aria-label="Default  select example" id="product_id" name="product_id" style="padding: 0.375rem 0.75rem;">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" aria-label="Default  select example" name="variant_id" id="variant_id" style="padding: 0.375rem 0.75rem;display:none;">
                ...
                <div class="row mt-2">
                    <div class="col-md-4">
                        ...
                        <select class="form-select product_info" aria-label="Default  select example" name="admin_id" style="padding: 0.375rem 0.75rem;">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select product_info" aria-label="Default  select example" name="type" style="padding: 0.375rem 0.75rem;">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control datetimeplugin" name="date_from" id="" value="{{Request::get('date_from')}}">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-4">
                            ...
                            <input class="form-control datetimeplugin" name="date_to" id="" value="{{Request::get('date_to')}}">
                        </div>
                    </div>
