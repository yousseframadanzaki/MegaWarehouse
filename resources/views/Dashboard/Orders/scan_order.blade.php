            ...
            <table class="table table-hover" id="variants_table">
                ...
                <tbody>
                    ...
                    <tr class="items" id="{{$item->variant->sku}}" data-sku="{{$item->variant->sku}}">
                        ...
                        <td data-variant_shelf_num="{{$item->variant->shelf_num}}">{{$item->variant->shelf_num}}</td>
            ...
            $.ajax({
                ...
                if (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (productName == item.product.name) {
                            $('.items_row').find('.product_' + item.sku).css({
                                backgroundColor: '#46b346',
                                color: 'white'
                            });
                        } else {
                            $('.items_row').find('.product_' + item.sku).css({
                        ...
                        if (variantName == item.name) {
                            $('.items_row').find('.variant_' + item.sku).css({
                                backgroundColor: '#46b346',
                                color: 'white'
                            });
                        } else {
                ...
                $('.items').each(function(index) {
                    ...
                    if (count == quantity_count) {
                        $('.items_row').find(".quantity_" + sku).css({
                            backgroundColor: '#46b346',
                            color: 'white'
                        });
                    } else {
