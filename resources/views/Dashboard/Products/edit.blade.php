    ...
    <div class="p-3">
        ...
        <div class="row  needs-validation " novalidate>
            ...
            <div class="card p-3 shadow-sm">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select product_info" aria-label="Default  select example" name="brand_id" style="padding: 0.375rem 0.75rem;">
                                ...
                                @foreach ($data['brands'] as $id => $name)
                                    <option @if($data['product']->brand_id == $id) selected @endif value="{{ $id }}">{{ $name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="number"
                                ...
                                name="before_sale_price" value="{{ $data['product']->before_sale_price }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control product_info @error('cost') is-invalid @enderror"
                                name="cost" value="{{ $data['product']->cost }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select product_info" aria-label="Default select example" name="supplier_id">
                                ...
                                @foreach ($data['suppliers'] as $id => $name)
                                    <option  @if($data['product']->supplier_id == $id) selected @endif value="{{ $id }}">{{ $name }}</option>
                                @endforeach
                            </select>
                ...
                <button id="add_product_btn" type="submit" class="btn btn-primary btn-lg">تعديل المنتج <i
