    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="row">
                ...
                <div class="col-md-3 fs-5 mb-2"><span style="font-weight: 600;">الماركة : </span><span><a href="{{ route('show_brand',$product->brand_id) }}">{{$product->brand->name}}</a></span></div>
                <div class="col-md-3 fs-5 mb-2"><span style="font-weight: 600;">المورد : </span><span><a href="{{ route('show_supplier',$product->supplier_id) }}">{{$product->supplier->name}}</a></span></div>
                <div class="col-md-12 fs-5 mb-2"><span style="font-weight: 600;">التصنيف : </span><span><a href="{{ route('show_category',$product->category_id) }}">{{$product->category->parents_names}}</a></span></div>
            </div>
            <div class="row mt-2">
