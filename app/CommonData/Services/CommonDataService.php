...
class CommonDataService implements CommonDataServiceInterface{
    ...
    public function GetRolesByType($company_id,$user_type_id){
        return $this->common_data_repository->get_roles_by_type($company_id,$user_type_id);
    }
    ...
    public function GetProductVariants($product_id, $is_bundle = 0){
        return $this->common_data_repository->get_product_variants($product_id, $is_bundle);
    }
