...
class ProductController extends Controller
{
    ...
    public function update(CreateProductRequest $request, $product_id)
    {
        ...
        if (!$product) {
            $request->session()->flash('erroe', 'updated_error');
            return redirect()->back();
        }

        $request->session()->flash('success', 'updated_success');
    ...
    public function update_variant(Request $request)
    {
        ...
        if (!$variant)
            return redirect()->back()->with('error', 'updated_error');

        return redirect()->back()->with('success', 'updated_success');
    }
